...
public class UserServiceExceptionDetailBuilder implements ServiceExceptionDetailBuilder<UserServiceException> {
    ...
    public String buildDetail(UserServiceException exception) {
        return switch (exception.getErrorCode()) {
            ...
            case "USER_STATUS_UPDATE_FAILED" -> "Cannot update the status of this user. Verify the current status and try again.";
            case "USER_REGISTRATION_FAILED" -> "Registration could not be completed due to an internal error. Please try again later.";
