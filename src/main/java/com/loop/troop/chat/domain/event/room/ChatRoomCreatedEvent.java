...
public record ChatRoomCreatedEvent(UUID eventId, ChatRoomEventType type, String aggregateId, String roomName,
		User createdBy, String payload, LocalDateTime occurredOn) implements ChatRoomEvent {

	public ChatRoomCreatedEvent(String aggregateId, String roomName, User createdBy) {
		this(UUID.randomUUID(), ChatRoomEventType.CHAT_ROOM_CREATED, aggregateId, roomName, createdBy,
				"Room created by " + createdBy, LocalDateTime.now());
	}
}
