package com.loop.troop.chat.shared.advice;

import com.loop.troop.chat.shared.error.service.ErrorLogService;
import com.loop.troop.chat.shared.exception.ServiceException;
import com.loop.troop.chat.shared.registry.builder.ServiceExceptionDetailBuilder;
import com.loop.troop.chat.shared.registry.ServiceExceptionDetailRegistry;
